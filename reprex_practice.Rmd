...
buses <- tribble(~bus_id, ~bus_route, ~bus_driver,
                 "bus_a", "work", "dan", 
                 "bus_b", "school", "tony", 
                 "bus_c", "party", "patty") 
...
## We want all of our column values to be upper case because the data frame is
## awesome. A common mistake could be to use the function toupper() within the 
## where function, but it belongs within the across function
...
penguins %>% 
  ggplot(aes(x = flipper_length_mm, y = body_mass_g)) +
         geom_point(shape = 5, alpha = 0.5) +
         theme_minimal() +
         labs(x = "Flipper Length",
              y = "Weight (g)")

## Shape = 5 belong outside of the aes() function because it is not based on 
## a variable
